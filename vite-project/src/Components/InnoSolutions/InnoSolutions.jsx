  ...
  const solutions = [
    {
      ...
      description: "Code It Consulting's finance services streamline and optimize financial operations.",
    ...
    },
    {
      id: 2,
      title: "Health Care",
      description: "Healthcare requires secure, interoperable IT for patient data and compliance.",
    ...
    },
    {
      id: 3,
      title: "Banking",
      description: "Code It Consulting's Banking Services streamline and optimize financial operations.",
  ...
  return (
    <div className="inno-solutions">
      <div className="inno-header">
        <p className="inno-subtitle" style={{color:"white"}}>INDUSTRIES WE WORK IN</p>
        <div className="inno-title-container">
          <h1 className="inno-title" style={{color:"white"}}>Innovative Solutions for Diverse Industries</h1>
          <p className="inno-description" style={{color:"white"}}>
            We provide innovative and tailored solutions across various industries to meet their evolving demands. 
            In finance and banking, we enhance security, streamline transactions, and drive customer-focused advancements
          </p>
        </div>
      </div>
      ...
      <div className="solutions-container">
        ...
        <div className="solution-tabs">
          {solutions.map((solution) => (
            ...
            >
              <span className="tab-number">{solution.id.toString().padStart(2, '0')}</span>
        ...
        <div className="solution-main-display">
          ...
          >
            ...
            <div className="solution-main-content">
              <span className="main-number">{activeSolutionData?.id.toString().padStart(2, '0')}</span>
              <h2 className="main-title">{activeSolutionData?.title}</h2>
              <p className="main-description">{activeSolutionData?.description}</p>
            </div>
          </div>
        </div>
      </div>
