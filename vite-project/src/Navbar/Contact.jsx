          ...
          <div className="row align-items-center">
                ...
                <div className="contact-two__content">
                  ...
                  <ul className="contact-list">
                    ...
                    <li>
                      ...
                      <a href="#0">
                        #402, 4<sup>th</sup> Floor, Manjeera Trinity Corporate, KPHB, Hyderabad, 500072
                      </a>
                    </li>
                    <li>
                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="mailto:hello@codeitconsulting.co.in">
                        <p className="mt-30">
                          hello@codeitconsulting.co.in
                          <span style={{ display: 'block' }}></span>
                          <i className="fa-solid fa-phone fs-5 my-1"></i> 8985998978
                        </p>
                      </a>
                    </li>
                  </ul>
                ...
                <div className="contact-two__form">
                  <form id="contact_form" name="contact_form">
                    <div className="row g-4 mb-4">
                      <div className="col-6">
                        <div className="input">
                          <input name="form_name" id="form_name" type="text" placeholder="Enter Name" />
                        </div>
                      </div>
                      <div className="col-6">
                        <div className="input">
                          <input name="form_email" id="form_email" type="email" placeholder="E-mail address" />
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" className="btn-one mt-50" id="submitBtn">
                      Send message
                    </button>
                  </form>
                </div>
            ...
            <div className="col-xl-5 order-1 order-xl-1">
              <div className="contact-two__map">
                <img src="https://html.kodesolution.com/2024/stratify-html/images/contact/map.png" alt="location map" />
              </div>
            </div>
          </div>
        </div>
