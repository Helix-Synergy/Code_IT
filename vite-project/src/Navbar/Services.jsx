  ...
  >
    <h1 className="services-main-title">Services</h1>
      ...
      <img src="/Images/digital-transformation.webp" alt="Digital Transformation" />
        ...
        <div className="services-text-content">
          ...
          <p className="services-section-description">
            ...
            Code IT Consulting, our Digital Transformation services are designed to help businesses embrace innovation and stay competitive in an increasingly tech-driven world. We guide you through the entire transformation journey, from analyzing your current systems to implementing cutting-edge solutions that enhance efficiency, streamline processes, and drive growth. Our team leverages advanced technologies such as cloud computing, AI, and automation to create a seamless digital ecosystem that aligns with your business goals. Whether you're looking to modernize legacy systems or integrate new digital tools, Code IT Consulting is your trusted partner in transforming your business for the future.
          </p>
        </div>
      </div>
      ...
      <div className="services-section services-section-normal">
        <div className="services-text-content">
          ...
          <p className="services-section-description">
            In today's interconnected world, cybersecurity is no longer an option—it's a necessity. At Code IT Consulting, we understand the critical importance of safeguarding your digital assets from evolving threats. Our comprehensive cybersecurity services are designed to provide robust protection, ensuring the confidentiality, integrity, and availability of your valuable data.

            Our experienced cybersecurity professionals stay ahead of the latest threats and technologies, ensuring your business remains protected. We work closely with you to develop a comprehensive security strategy that aligns with your business objectives and regulatory requirements. Partner with Code IT Consulting to fortify your defenses and build a resilient security posture.
          </p>
        </div>
        <div className="services-img-box">
    ...
    <img src="/Images/network-people-digital-world_9975-23272.avif" alt="Networking" />
        ...
        <div className="services-text-content">
          ...
          <p className="services-section-description">
            Modernize your network infrastructure with Code IT Consulting. We specialize in designing and implementing next-generation networks that support cloud integration and digital transformation. Our services include software-defined networking (SDN), network virtualization, and cloud connectivity solutions.

            We specialize in building and maintaining robust network infrastructures that support high performance, scalability, and security. From setting up local area networks (LAN) to managing wide area networks (WAN), our expert team works to optimize connectivity, improve data flow, and reduce downtime. Whether you need network design, implementation, or ongoing management, Code IT Consulting provides solutions that enhance collaboration, boost productivity, and keep your business connected with ease.
          </p>
        </div>
      </div>
